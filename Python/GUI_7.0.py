...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Main vertical layout: [HLine] on top, [panels row] below
        ...
        main_vlayout.addLayout(control_row)
        ...
        self.btn_set_pressure_max   = QtWidgets.QPushButton("Set Max Pressure")
        ...
        self.btn_set_freq = QtWidgets.QPushButton("Set ESP32 Freq")

        self.label_cycles = QtWidgets.QLabel("Loop Cycles:")
        self.label_start = QtWidgets.QLabel("Top Position:")
        self.label_stop = QtWidgets.QLabel("Bottom Position:")
        self.label_max_pressure = QtWidgets.QLabel("Stop Pressure [mbar]:")
        
        control_row.addWidget(self.btn_zero_all_p)
        control_row.addWidget(self.btn_stop_all)
        control_row.addWidget(self.btn_loop_all)
        control_row.addWidget(self.label_cycles)
        control_row.addWidget(self.entry_cycles)
        control_row.addWidget(self.label_start)
        control_row.addWidget(self.entry_start)
        control_row.addWidget(self.label_stop)
        control_row.addWidget(self.entry_stop)
        control_row.addWidget(self.label_max_pressure)
        control_row.addWidget(self.entry_max_pressure)
        control_row.addWidget(self.btn_set_pressure_max)
        control_row.addWidget(self.btn_set_freq)
        control_row.addWidget(self.entry_set_freq)

        self.btn_zero_all_p.clicked.connect(lambda: btn_zero_all_p_func(self))
        self.btn_stop_all.clicked.connect(lambda: btn_stop_all_func(self)) 
        self.btn_loop_all.clicked.connect(lambda: btn_loop_all_func(self)) 
        self.btn_set_pressure_max.clicked.connect(lambda: set_pressure_max_func(self)) 
        self.btn_set_freq.clicked.connect(lambda: btn_set_freq_func(self))
        ...
        # Make sure it expands horizontally and stays thin vertically
        ...
        self.serial_start.start(1000)  # 2 Hz
