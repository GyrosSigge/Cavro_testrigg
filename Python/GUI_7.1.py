...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # ===== Emergency Stop =====
        emergency_box = QtWidgets.QGroupBox("Emergency")
        emergency_layout = QtWidgets.QVBoxLayout(emergency_box)
        self.btn_stop_all = QtWidgets.QPushButton("STOP ALL")
        self.btn_stop_all.setStyleSheet("background-color: red; color: white; font-weight: bold; font-size: 16px; height: 40px;")
        emergency_layout.addWidget(self.btn_stop_all)
        controls_layout.addWidget(emergency_box)
        ...
        # ===== Safety =====
        safety_box = QtWidgets.QGroupBox("Safety")
        safety_layout = QtWidgets.QGridLayout(safety_box)

        self.entry_max_pressure = QtWidgets.QLineEdit("7000")
        self.btn_set_pressure_max = QtWidgets.QPushButton("Set Max Pressure")
        safety_layout.addWidget(QtWidgets.QLabel("Max Pressure [mbar]:"), 0, 0)
        safety_layout.addWidget(self.entry_max_pressure, 0, 1)
        safety_layout.addWidget(self.btn_set_pressure_max, 0, 2)

        self.entry_set_freq = QtWidgets.QLineEdit("100")
        self.btn_set_freq = QtWidgets.QPushButton("Set Freq")
        safety_layout.addWidget(QtWidgets.QLabel("Hz:"), 1, 0)
        safety_layout.addWidget(self.entry_set_freq, 1, 1)
        safety_layout.addWidget(self.btn_set_freq, 1, 2)
